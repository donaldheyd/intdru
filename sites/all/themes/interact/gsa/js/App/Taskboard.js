(function (global, factory) {
  ...
  var Subtask = function () {
    ...
    babelHelpers.createClass(Subtask, [{
      ...
      key: 'getTpl',
      value: function getTpl(content) {
        return '<span class="task-badge task-badge-subtask icon md-list-bulleted">' + content + '</span>';
      }
    }]);
    return Subtask;
  }();
  ...
  var Attachment = function () {
    ...
    babelHelpers.createClass(Attachment, [{
      ...
      key: 'getTpl',
      value: function getTpl(content) {
        return '<span class="task-badge task-badge-attachments icon md-paperclip">' + content + '</span>';
      }
    }]);
    return Attachment;
  }();
  ...
  var Comment = function () {
    ...
    babelHelpers.createClass(Comment, [{
      ...
      key: 'getTpl',
      value: function getTpl(content) {
        return '<span class="task-badge task-badge-comments icon md-chat">' + content + '</span>';
      }
    }]);
    return Comment;
  }();
