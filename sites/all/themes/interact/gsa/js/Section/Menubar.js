      ...
      value: function setupMenu() {
        if (typeof _jquery2.default.fn.mmenu !== 'undefined') {
          this.$el.mmenu({
            ...
            navbars: [{
              position: 'bottom',
              content: ['<div class="site-menubar-footer">\n              <a href="views/_settings.html" class="fold-show" data-placement="top" data-toggle="tooltip" data-original-title="Settings">\n                <span class="icon md-settings" aria-hidden="true"></span>\n              </a>\n              <a href="views/_profile.html" data-placement="top" data-toggle="tooltip" data-original-title="Profile">\n                <span class="icon md-account-circle" aria-hidden="true"></span>\n              </a>\n              <a href="javascript: void(0);" data-placement="top" data-toggle="tooltip" data-original-title="Logout">\n                <span class="icon md-power" aria-hidden="true"></span>\n              </a>\n            </div>']
            }]
          });
        }
      }
